...
<div class="container-fluid mt-5">
    ...
    <div class="panel panel-info bg-white p-5">
        <div class="panel-heading">
            <h3 class="panel-title">Tambah Data Ayah</h3>
        </div>
        <div class="panel-body">
        <form action="{{ $url = route('ayah.store') }}" method="post" class="needs-validation" novalidate>
                {{ csrf_field() }}
        ...
        <button type="submit" class="btn btn-success">Simpan Data Ayah</button>
        </form>
